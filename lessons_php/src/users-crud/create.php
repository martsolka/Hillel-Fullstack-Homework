...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  $isCreated = (new UserModel)->create($_POST);
  if ($isCreated) {
    $_SESSION['alert'] = ['content' => '✔ User created successfully!', 'type' => 'success'];
    AuthManager::goTo('/users-crud/');
  }
}

$pageTitle = 'Users CRUD | Create User';
      ...
      <main class="card-body h-100 overflow-y-auto">
        <div class="row my-3">
          <div class="col-12 text-center">
            ...
            <p class="lead text-body-secondary">
              Fill out the form below to create a new user account and save it to the database.
            </p>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-10 col-lg-8">
            <form class="row justify-content-center gy-4 small" id="user-form" action="create.php" method="POST" novalidate>
