          ...
          <div class="row g-3">
            <div class="col-sm-6 vstack gap-3">
              <div class="form-floating">
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="productName" name="name" placeholder="Product Name" value="{{ old('name', $product->name) }}">
              ...
              <div class="form-floating flex-grow-1">
                <textarea class="form-control h-100 @error('description') is-invalid @enderror" id="productDescription" name="description" placeholder="Product Description">{{ old('description', $product->description) }}</textarea>
            ...
            <div class="col-sm-6 vstack gap-3">
              <div class="form-floating">
                <input type="number" class="form-control @error('price') is-invalid @enderror" id="productPrice" name="price" placeholder="Product Price" value="{{ old('price', $product->price) }}">
