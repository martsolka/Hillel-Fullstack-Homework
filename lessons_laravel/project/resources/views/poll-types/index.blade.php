            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <button class="btn btn-sm bg-light-subtle" data-bs-toggle="modal" data-bs-target="#delete-poll-type-{{ $pollType->id }}">❌</button>
                  @include('poll-types.delete-confirm', ['pollType' => $pollType])
                </td>
              </tr>
              @empty
              <tr>
